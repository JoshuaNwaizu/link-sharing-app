...
//         // Fetch profile and links concurrently
//         await Promise.all([
...
//               alt="profile"
//               className="rounded-full object-cover border-4 border-[#633CFF] w-[6rem] h-[6rem]"
//             />
//           )}
//           <h1 className="capitalize text-[2rem] font-bold leading-[3rem]">
